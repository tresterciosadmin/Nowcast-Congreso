...
- **Estado:** modelo/ensemble y variables/proyecto EN CURSO. **Pendiente mayor:** migrar la Puerta B (Diputados) a la misma señal de alineación y re-backtestear la cadena completa; arreglar el bug de acuerdos en actas_ley.py.
