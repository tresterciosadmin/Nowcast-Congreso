...
**Propósito.** Ingesta de votaciones del Senado (DatosAbiertos Senado + argentinadatos).

**Estado:** PENDIENTE
**Owner actual:** _(vacante — reclamalo en coordinacion/TABLERO.md antes de empezar)_

## Contrato
- **Entradas:** senado.gob.ar/DatosAbiertos, argentinadatos
- **Salida (contrato estable):** data/clean/senado_*.parquet
- **Depende de:** docs/schemas
- **Gate de pase:** Mapeo de bloques del Senado resuelto
