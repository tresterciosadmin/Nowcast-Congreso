...
const TABLERO = {
  ...
  modulos_repo: [
    ...
    { modulo: "modelo/ensemble", estado: "EN CURSO", owner: "Claude+Valle", nota: "v1 puesta en marcha: P(aprobación) = P(llega al recinto) × P(mayoría). Nuevo comando nowcast_auto: arma el escenario SOLO desde variables/bloque (composición del padrón + postura histórica), sin escenario a mano. Primer end-to-end con cámara real: 1167-D-2025 → 15% (llega) × 100% (mayoría) = 15%, 137 afirmativos (banda 131-143) vs umbral 123, roster 257. CASO TESTIGO bicameral (salteando el embudo): Diputados 137/123 (ajustado) · Senado 61 de 72 vs umbral 33 (paliza), ambas ~100% → P(sanción)≈100%, IRREAL: es el artefacto de la dirección INCONDICIONAL del v1. Falta: dirección de bloque condicionada al tema/origen (v2, PRIORIDAD) y p_llega del embudo por id." },
