...
const TABLERO = {
  ...
  actualizado_por: "Valle (con Claude) — Sesion 04-ago, dos frentes. DATOS: ICG enchufado al embudo (aporta 0, y en el camino aparecio un bug silencioso que dejaba muertas las 25 columnas de comisiones); PADRON VIVO con vigilante semanal y padron de Diputados a 257 exactos; 2 workflows nuevos en Actions. MODELO: **el ICG deja de ser un rasgo y pasa a ser MODULADOR DE COYUNTURA (ADR-0008)**. Dos mecanismos: uno MEDIDO que mueve legislador por legislador (gamma 0,22 a 0,56 segun cuan discolo, dosis-respuesta, sobre 410k votos) y uno DECLARADO que asigna un analista humano en un panel. El modelo ordeno la camara solo: los provinciales son los sensibles al clima, LLA/kirchnerismo/PRO el nucleo duro. Requisito nuevo: ningun nowcast se publica sin evaluacion de coyuntura registrada. Tres paneles HTML, uno para telefono que recalcula 12 proyectos en vivo.",
