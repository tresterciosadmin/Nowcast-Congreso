...
const TABLERO = {
  ...
  actualizado_por: "Valle (con Claude) — Sesión 22-23 jul: (1) ROSTER NOMINAL en el ensemble (simula legislador por legislador con su desvío; se eliminó el atajo que promediaba por bloque). (2) ORIGEN por acta (quién impulsa + gobierno de turno, determinístico sin API key; 59% global / 54,5% Senado). (3) LINAJE del Senado recuperado desde el padrón (el nowcast del Senado ya condiciona; OTRO/PROVINCIAL 53%→26%, 22 senadores completados a mano). (4) La postura EXCLUYE actas AUX (consenso). Validado: proyecto de salud opositor → gobierno NEGATIVO, oposición AFIRMATIVO. Pendiente: backtest de la cadena + más cobertura de actas + multitemáticas.",
